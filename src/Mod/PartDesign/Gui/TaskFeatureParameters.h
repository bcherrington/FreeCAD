...
protected:
    ...
    )
    {
        ...
        deferredRejectSetPending = [this,
                                    parameterGuard,
                                    updatePending = std::forward<UpdatePendingFn>(updatePending)](
                                       bool pending
                                   ) mutable {
            setDeferredDialogRejectPending(
                deferredReject,
                pending,
                buttonBox,
                [parameterGuard, &updatePending](bool pending) mutable {
                    if (parameterGuard) {
